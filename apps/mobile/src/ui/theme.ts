...
/*
 * Apple HIG — iOS System palette.
 * Primary: iOS System Blue (#007AFF / dark #0A84FF) — system-default for interactive elements.
 * Secondary: campus gold for achievement/reward signal only (kept restrained for low-frequency use).
 * Status colors follow iOS system colors (#34C759 green / #FF9500 orange / #FF3B30 red).
 */
