...
| 倉儲級稽核與待修盤點 | [`AUDIT_REPORT.md`](AUDIT_REPORT.md)、[`AUDIT_V2.md`](AUDIT_V2.md)（Web **`apps/web/src`** 條列式 dead CTA／跨頁對齊／示範洩漏備忘）、[`docs/REMAINING_BUGS_AUDIT.md`](docs/REMAINING_BUGS_AUDIT.md)、[`docs/CONSOLIDATION_PLAN.md`](docs/CONSOLIDATION_PLAN.md) |
...
- **重算「專案快照」表格中的計數**（與本 README **基準日 2026-05-17 第三次 push** 對目前 repo **已 commit** 狀態之表一致時，下列指令應得到：**1137**／**151**／**15**／**81**／5／24／**32**／4／5／12；日後若數字漂移，請以指令輸出為準並更新表格，`git ls-files | wc -l` 請在 **已 commit** 後複核）：
...
<h3 id="readme-qa-20260517">本期程式與 QA 對照摘要（2026-05-15–17，含 05-17 push）</h3>
