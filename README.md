...
| 面向              | 盤點結果                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git tracked files | **`965`** 個（**複核**：`git ls-files \| wc -l`；基準日 **2026-05-15**，含智慧點名共用引擎、`8_CHIPS_FINAL_AUDIT`、驗證 tool、Companion 本地快取、除錯畫面／文件、TronClass 行動 LMS 調整與 **`TRONCLASS_REAL_SCHEMA_2026_05_13`**）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
