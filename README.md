...
| 學伴／引擎／NL 測試 | 鎖定 **`spriteEngine`**、學伴深度整合、`inboxActions`、開放式自然語言測試等回歸。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | [`spriteEngine.test.ts`](apps/mobile/src/__tests__/spriteEngine.test.ts)、[`companionDeepIntegration.test.ts`](apps/mobile/src/__tests__/companionDeepIntegration.test.ts)、[`inboxActions.test.ts`](apps/mobile/src/__tests__/inboxActions.test.ts)、[`aiOpenEndedNaturalLanguage.test.ts`](apps/mobile/src/__tests__/services/aiOpenEndedNaturalLanguage.test.ts)                                                                                                                                                                                                                                                                                                |
...
- **LMS 演算法契約：** `quizScoring`、`gradebookCompute`、`questionBank`、`rubricScoring`、`discussionEngine`、`riskRadar`、`tronclassAdapter`（見 `packages/shared/src/lms/`）。
