...
| LMS v2／Supabase 遷移執行手冊 | [`docs/LMS_V2_MIGRATION_RUNBOOK.md`](docs/LMS_V2_MIGRATION_RUNBOOK.md)（PostgreSQL、migrations、`supabase` Edge deploy、Firebase **JWT**、`lmsV2FeatureFlag`、`perCourseAIContext`；對照 [`backend/functions/lmsV2/README.md`](backend/functions/lmsV2/README.md)；整合計畫稿 [`LMS_整合計畫.docx`](LMS_%E6%95%B4%E5%90%88%E8%A8%88%E7%95%AB.docx)） |
...
| 角色感知 Today／五身分中控台 | [`docs/ROLE_AWARE_HOMES_2026_05_15.md`](docs/ROLE_AWARE_HOMES_2026_05_15.md)（demo uid／`resolveDashboardRole`／`HomeStack` 對照）；示範用 **口試主持腳本**、**角色資料與畫面對照矩陣**見 repo 根目錄 `口試Demo主持腳本.docx`、`角色資料畫面對照矩陣.xlsx` |
...
| Demo 資料流／最終版 SOP | [`docs/DEMO_DATA_FLOW_MAP.md`](docs/DEMO_DATA_FLOW_MAP.md)、[`docs/DEMO_FINAL_AND_DEV_SOP_2026_05_15.md`](docs/DEMO_FINAL_AND_DEV_SOP_2026_05_15.md)、[`docs/USER_JOURNEY_REALITY_2026_05_15.md`](docs/USER_JOURNEY_REALITY_2026_05_15.md)、[`docs/DEMO_NARRATIVE.md`](docs/DEMO_NARRATIVE.md)；示範診斷清單：[`DEMO_診斷清單.md`](DEMO_診斷清單.md) |
...
| 口試簡報（pptx） | [`口試簡報.pptx`](口試簡報.pptx)（與 README／`ROLE_AWARE` 文件、`demo_預覽` mockup 並列為口試備品） |
...
- **重算「專案快照」表格中的計數**（與本 README **基準日 2026-05-17（含 LMS v2 第五批 push）** 對目前 repo **已 commit** 狀態之表一致時，下列指令應得到：**1257**／**151**／**15**／**81**／5／24／**32**／4／5／12；**`git ls-files | wc -l`** 在第五批（**`supabase/`**、`**lmsV2*`、staged、`LMS_V2_*`、[LMS\_整合計畫.docx](LMS_%E6%95%B4%E5%90%88%E8%A8%88%E7%95%AB.docx)) 併入後應為 **1257**；第四批為止為 **1138**；日後若數字漂移，請以指令輸出為準並更新表格，`git ls-files | wc -l` 請在 **已 commit** 後複核）：
...
下列數字為 **2026-05-17 第三～五次 GitHub push 批次**（第三批：離線端到端硬化與 QA 文件；**第四批**：Web `AUDIT_V2` 收斂、**🤖** 深連結、公告退回與 **`AUDIT_V2_FIXED.md`**；**第五批**：LMS v2／**`supabase/`**、migrations、`lmsV2FeatureFlag`、Firebase **`issueSupabaseJwt`**、[執行手冊](docs/LMS_V2_MIGRATION_RUNBOOK.md)，**tracked +119**，第四批快照 **1138**→**1257**）對 **已 commit** repo 之盤點（見上方 **`2026-05-17` blockquote**「第三～五批」與「複核指令」）。**前一版（0516）**之 **1084／142／78／29** 僅見歷史敘述與區塊內對照。

| 面向              | 盤點結果                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git tracked files | **`1257`** 個（**複核**：`git ls-files \| wc -l`。**2026-05-17：** 第五批 LMS v2 將 tracked **1138**→**1257**（約 **119** paths）。**第四批對照：** **+1**＝根目錄 **[`AUDIT_V2_FIXED.md`](AUDIT_V2_FIXED.md)**。**05-17（第四批對照前文）本批**：示範狀態與控制台 — [`demoRole.tsx`](apps/mobile/src/state/demoRole.tsx)、[`CombinedProviders.tsx`](apps/mobile/src/state/CombinedProviders.tsx)、[`AIAgentConsoleScreen.tsx`](apps/mobile/src/screens/AIAgentConsoleScreen.tsx)、[`AgentSummaryBanner.tsx`](apps/mobile/src/components/AgentSummaryBanner.tsx)、[`aiAgentRuntime.ts`](apps/mobile/src/services/aiAgentRuntime.ts)、[`personaContext.ts`](apps/mobile/src/services/personaContext.ts)，以及 `aiSemanticReasoner`／`aiAgentTools`／`AIChat`／`Observatory` 連動。**風險／場域** — [`studentRiskEngine.ts`](apps/mobile/src/services/studentRiskEngine.ts)、[`StudentRiskScreen.tsx`](apps/mobile/src/screens/StudentRiskScreen.tsx)、[`indoorMaps.ts`](apps/mobile/src/data/indoorMaps.ts)、[`IndoorFloorMapScreen.tsx`](apps/mobile/src/screens/IndoorFloorMapScreen.tsx)、[`tdxLive.tsx`](apps/mobile/src/services/tdxLive.tsx)、[`offlineCache.ts`](apps/mobile/src/services/offlineCache.ts)。**導頁／事件／地標** — [`routeRegistry.ts`](apps/mobile/src/utils/routeRegistry.ts)、[`safeNavigate.ts`](apps/mobile/src/utils/safeNavigate.ts)、[`roleEventBus.ts`](apps/mobile/src/services/roleEventBus.ts)、[`savedPlaces.ts`](apps/mobile/src/services/savedPlaces.ts)。**商家／敘事** — [`VendorLoyaltyPushScreen.tsx`](apps/mobile/src/screens/VendorLoyaltyPushScreen.tsx)、[`VendorMenuManageScreen.tsx`](apps/mobile/src/screens/VendorMenuManageScreen.tsx)、[`VendorRevenueReportScreen.tsx`](apps/mobile/src/screens/VendorRevenueReportScreen.tsx)、[`DemoStoryScreen.tsx`](apps/mobile/src/screens/DemoStoryScreen.tsx)、[`LifeRequestsScreen.tsx`](apps/mobile/src/screens/LifeRequestsScreen.tsx)、[`TeachingEvaluationScreen.tsx`](apps/mobile/src/screens/TeachingEvaluationScreen.tsx)。**Web** — [`demoStore.ts`](apps/web/src/lib/demoStore.ts)、[`useRoleScopedState.ts`](apps/web/src/lib/useRoleScopedState.ts)、[`roleNotifications.ts`](apps/web/src/lib/roleNotifications.ts)、[`messages/page.tsx`](apps/web/src/app/messages/page.tsx)、[`announcements/[id]/page.tsx`](apps/web/src/app/announcements/[id]/page.tsx)、[`admin/students/[id]/page.tsx`](apps/web/src/app/admin/students/[id]/page.tsx) 與多頁 `SiteShell` 連動。**第三批（Web/mobile 對齊 + QA）** — 首頁／`bus`／`cafeteria`／社團與群組／圖書／成績／個人／搜尋／登入設定／`/ai-assistant`／教師 `gradebook`×`quizzes`、[`SiteShell`](apps/web/src/components/SiteShell.tsx) 頁尾、`AIMissionControl`／`demoPersona`／訊息工作台等（對照上方 blockquote「**第三批**」）。**文件／工具**：[AUDIT_REPORT.md](AUDIT_REPORT.md)、[AUDIT_V2.md](AUDIT_V2.md)、[`docs/FINAL_VERIFICATION.md`](docs/FINAL_VERIFICATION.md)、[`docs/DEMO_SCRIPT_FINAL.md`](docs/DEMO_SCRIPT_FINAL.md)、[`docs/FEATURE_CONSOLIDATION_FINAL.md`](docs/FEATURE_CONSOLIDATION_FINAL.md)、[`docs/ROLE_ACTION_DATA_MATRIX_FINAL.md`](docs/ROLE_ACTION_DATA_MATRIX_FINAL.md)、[`docs/口試最終檢核清單.md`](docs/口試最終檢核清單.md)、[`docs/REMAINING_BUGS_AUDIT.md`](docs/REMAINING_BUGS_AUDIT.md)、[`docs/CROSS_ROLE_DATA_FLOW.md`](docs/CROSS_ROLE_DATA_FLOW.md)、[`docs/ROLE_FEATURE_MATRIX.md`](docs/ROLE_FEATURE_MATRIX.md)、[`docs/DEMO_NARRATIVE.md`](docs/DEMO_NARRATIVE.md)、[`docs/CONSOLIDATION_PLAN.md`](docs/CONSOLIDATION_PLAN.md)；[`start-demo-for-screenshots.sh`](start-demo-for-screenshots.sh)；[`demo_預覽/persona_switch_demo.html`](demo_預覽/persona_switch_demo.html)。**口試資產（根目錄）**：`_v2`／`_v3` 版簡報、主持腳本、交付 README、角色矩陣 xlsx。**更早主線（0516 含 BusV2、信任卡、Web admin 三頁）**見上方連續 blockquote。）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Mobile UI         | **`151`** 個 `apps/mobile/**/*Screen.tsx`、`15` 個 `*Stack.tsx`（複核：`find apps/mobile/src/screens -name '*Screen.tsx' \| wc -l`，Stack 請用 `find … '*Stack.tsx'`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Web routes        | **`32`** 個 `apps/web/**/page.tsx`、`4` 個 `apps/web/**/route.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
<h3 id="readme-qa-20260517">本期程式與 QA 對照摘要（2026-05-15–17，含 05-17 第三～四批 push）</h3>
...
- **Repo 資產（非程式）：** **`demo_預覽/campus_bus_map_v2_mockup.html`**—**離線**開啟即可檢視路網視覺；**`口試簡報.pptx`**—與 **`docs/ROLE_AWARE_*`**、[`DEMO_診斷清單.md`](DEMO_診斷清單.md) 並用。
...
**備註：** **`supabase/`**（PostgreSQL、migrations、Edge Functions）由 **Supabase CLI** 管理，**不包含**在上述 `pnpm` workspace paths 內；對照 **`docs/LMS_V2_MIGRATION_RUNBOOK.md`**。
...
- **為什麼存在：** 將 **PostgreSQL／Supabase** 作為與 Firebase／TronClass **並列的可選 LMS 後端**。主線程式在 **`lmsV2FeatureFlag` OFF**（或未設環境 key）時，行為等同未導入前。
- **單一事實來源：** **[`docs/LMS_V2_MIGRATION_RUNBOOK.md`](docs/LMS_V2_MIGRATION_RUNBOOK.md)** — migrations 順序、`supabase link`/`db push`、建議部署的 **4** 個 Edge Function、封存 **不部署**之 AI pipeline、以及如何掛載 **`backend/functions/lmsV2/issueSupabaseJwt`**；整合計畫稿見 **[`LMS_整合計畫.docx`](LMS_%E6%95%B4%E5%90%88%E8%A8%88%E7%95%AB.docx)**。
- **對 AI 的定位（與現有架構對齊）：** Supabase 僅承接 **資料**；對話／工具鏈仍以既有 **`chatWithCampusAssistant`**、`aiAgentRuntime`、以及 **`apps/mobile/src/services/`** 內現有 orchestrator／**`ai*`** pipeline 為準；[**`perCourseAIContext.ts`**](apps/mobile/src/services/perCourseAIContext.ts) 把 **`courseId`** 對應的 LMS 文本注入既有 **`AIChatScreen`**。
- **參考用 UI（半成品）：** Mobile [**`_lms_v2_staged/*.staged`**](apps/mobile/src/screens/_lms_v2_staged/README.md)、Web `_lms_v2_staged_admin`（未掛入主 App Router，且 [**`apps/web/tsconfig.json`**](apps/web/tsconfig.json) 已排除）。
