...
const MOCK_ROUTES: BusRoute[] = [
  {
    ...
    scheduleTimes: {
      weekday: ["05:30", "05:40", "05:50", "06:00", "06:10", "06:20", "06:30", "06:40", "06:50", "07:00", "07:10", "07:20", "07:30", "07:40"],
  ...
  },
  {
    ...
    scheduleTimes: {
      weekday: ["06:00", "06:15", "06:30", "06:45", "07:00", "07:15", "07:30", "07:45", "08:00", "08:15", "08:30", "08:45"],
  ...
  },
  {
    ...
    scheduleTimes: {
      weekday: ["06:30", "06:50", "07:10", "07:30", "07:50", "08:10", "08:30", "08:50", "09:10", "09:30"],
...
const MOCK_VEHICLES: BusVehicle[] = [
  { id: "v1", routeId: "route1", currentStopId: "s3", nextStopId: "s4", crowdLevel: "medium", eta: 5, plateNumber: "KAA-6312" },
  { id: "v2", routeId: "route1", currentStopId: "s1", nextStopId: "s2", crowdLevel: "high", eta: 15, plateNumber: "KAA-6358" },
  { id: "v3", routeId: "route2", currentStopId: "s8", nextStopId: "s9", crowdLevel: "medium", eta: 8, plateNumber: "KAB-1025" },
  { id: "v4", routeId: "route3", currentStopId: "s10", nextStopId: "s11", crowdLevel: "low", eta: 3, plateNumber: "FAE-551" },
];
