export type AssistantRuntimeProvider = "offline" | "mock" | "local-llm" | "cloud" | "gemini" | string;
...
export function buildAssistantCapabilityPrompt(context: AssistantProfilePromptContext = {}): string {
  ...
  return [
    ...
    "",
    "### 行為參數",
    ...Object.entries(ASSISTANT_CAPABILITY_PROFILE.behaviorParameters).map(([, value]) => `- ${value}`),
    "",
    "### 必守規則",
