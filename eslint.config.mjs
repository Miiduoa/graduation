        ...
        'error',
        {
          paths: [
            ...
            },
            {
              name: '../firebase',
              message:
                'Use DataSource or feature repositories instead of direct Firebase clients in screens.',
            },
            {
              name: '@react-native-async-storage/async-storage',
              message:
                'Use feature repositories or persisted storage helpers instead of AsyncStorage in screens.',
            },
          ],
        },
      ],
