  ...
  const announcements = [
    {
      ...
      content:
        '本學期註冊繳費日期為 2/15-2/28，請同學務必於期限內完成繳費。逾期未繳費者將依規定處理。',
      source: '教務處註冊組',
      category: 'academic',
      priority: 'high',
      tags: ['註冊', '繳費', '重要'],
    ...
    },
    {
      title: '校園徵才博覽會報名開始',
      content:
        '113 年度校園徵才博覽會將於 3/15 舉辦，預計有 80 家企業參與。歡迎應屆畢業生及在校生踴躍參加！',
      source: '學務處職涯發展中心',
      category: 'career',
      priority: 'normal',
      tags: ['徵才', '就業', '活動'],
    ...
    },
    {
      title: '圖書館寒假開放時間調整',
      content:
        '寒假期間（1/20-2/20）圖書館開放時間調整為 09:00-17:00，例假日休館。特殊開放時段請參閱圖書館網站公告。',
      source: '圖書館',
      category: 'facility',
      priority: 'normal',
      tags: ['圖書館', '開放時間'],
    ...
    },
    {
      title: '學生宿舍申請公告',
      content:
        '113 學年度第 2 學期學生宿舍申請將於 1/15 開始，請有需求的同學至住宿服務組網站填寫申請表。床位有限，先搶先贏！',
      source: '學務處住宿服務組',
      category: 'housing',
      priority: 'high',
      tags: ['宿舍', '申請', '住宿'],
    ...
    },
    {
      title: '校園網路維護通知',
      content:
        '預計於本週六 (1/20) 凌晨 02:00-06:00 進行校園網路設備維護，届時可能會有短暫斷線，敬請見諒。',
      source: '計算機中心',
      category: 'system',
      priority: 'normal',
      tags: ['網路', '維護'],
    ...
    },
    {
      title: '期末考試時間表公告',
      content:
        '113 學年度第 1 學期期末考試週為 1/8-1/14，請同學注意各科目考試時間及教室，並做好準備。',
      source: '教務處課務組',
      category: 'academic',
      priority: 'high',
      tags: ['考試', '期末', '重要'],
    ...
    },
    {
      title: '獎學金申請公告',
      content:
        '本學期各類獎學金開始申請，包含清寒獎學金、書卷獎、特殊表現獎學金等。詳情請至學務處網站查詢。',
      source: '學務處生活輔導組',
  ...
  const events = [
    {
      title: '校園徵才博覽會',
      description:
        '年度最大校園徵才活動，超過 80 家知名企業現場徵才。提供履歷健檢、職涯諮詢等服務。',
      location: '國際大樓',
      category: 'career',
      organizer: '職涯發展中心',
    ...
    },
    {
      title: '校慶運動會',
      description:
        '一年一度的校慶運動會，包含田徑、球類、趣味競賽等項目。為班級爭光，展現青春活力！',
      location: '運動場',
      category: 'sports',
      organizer: '體育室',
