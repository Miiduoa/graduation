...
/*
 * Campus OS — practical campus operations palette.
 * Primary: deep campus green, stable enough for repeated daily use.
...
export function createDarkTheme(
  ...
  return {
    ...
    colors: {
      ...
      surface2: '#1F2D28',
      surface3: '#283832',
      surfaceElevated: '#22322D',
      surfaceInteractive: '#20302A',
      surfaceInteractiveStrong: '#2A4038',
      surfaceMuted: '#121D19',
      border: '#30443C',
      separator: '#26362F',
      text: '#F4FBF7',
      textSecondary: '#B5C5BD',
      muted: '#83948C',
      accent,
      ...
      gradientEnd: '#8ABF7B',
      success: '#5EE0B8',
      successSoft: 'rgba(94,224,184,0.14)',
      danger: '#FF9A9A',
      error: '#FF9A9A',
      dangerSoft: 'rgba(255,154,154,0.14)',
      warning: '#F5C451',
      warningSoft: 'rgba(245,196,81,0.15)',
      info: '#8FB7FF',
      infoSoft: 'rgba(143,183,255,0.14)',
      focusRing: rgba(accent, 0.45),
      overlay: 'rgba(8,14,12,0.78)',
      ...
      streak: '#FF9A6B',
      streakSoft: 'rgba(255,154,107,0.14)',
      growth: '#5EE0B8',
      growthSoft: 'rgba(94,224,184,0.14)',
      calm: '#8FB7FF',
      calmSoft: 'rgba(143,183,255,0.14)',
      gentleWarn: '#F5C451',
      gentleWarnSoft: 'rgba(245,196,81,0.15)',
      urgent: '#FF9A9A',
      urgentSoft: 'rgba(255,154,154,0.14)',
      fresh: '#8FB7FF',
      freshSoft: 'rgba(143,183,255,0.14)',
      social: '#C8A6FF',
      socialSoft: 'rgba(200,166,255,0.16)',
      confidenceHigh: '#5EE0B8',
      confidenceHighSoft: 'rgba(94,224,184,0.14)',
      confidenceMedium: '#F5C451',
      confidenceMediumSoft: 'rgba(245,196,81,0.15)',
      confidenceLow: '#FF9A9A',
      confidenceLowSoft: 'rgba(255,154,154,0.14)',
      roleStudent: accent,
      roleStudentSoft: createAccentSoft(accent, 0.2),
      roleTeacher: '#8FB7FF',
      roleTeacherSoft: 'rgba(143,183,255,0.14)',
      roleAdmin: gold,
      ...
      card: '#22322D',
      onAccent: '#FFFFFF',
      chromeTabBar: 'rgba(22,32,28,0.97)',
      chromeTabBorder: 'rgba(255,255,255,0.11)',
      chromeTabItemActive: createAccentSoft(accent, 0.22),
    },
    shadows: {
      sm: { color: '#050907', opacity: 0.22, radius: 10, offsetY: 3, elevation: 2 },
      md: { color: '#050907', opacity: 0.3, radius: 18, offsetY: 5, elevation: 5 },
      lg: { color: '#050907', opacity: 0.38, radius: 24, offsetY: 8, elevation: 8 },
      xl: { color: '#050907', opacity: 0.46, radius: 34, offsetY: 12, elevation: 14 },
    ...
    gradients: {
      drawerHeader: ['#22322D', '#121D19'] as const,
      profileHero: ['#263A33', '#17231F', '#101714'] as const,
...
export function createLightTheme(
  ...
  return {
    ...
    colors: {
      ...
      surfaceInteractive: '#EEF4F1',
      surfaceInteractiveStrong: '#E2ECE7',
      surfaceMuted: '#F0F5F2',
      border: '#DCE7E1',
      separator: '#E8F0EC',
      /** 白底主文：對比約 16:1，利於 WCAG AA */
      text: '#14211D',
      textSecondary: '#3F514A',
      ...
      gradientStart: '#EEF4F1',
      gradientMid: '#E2ECE7',
      gradientEnd: '#FFFFFF',
      success: '#0F8A68',
      successSoft: 'rgba(15,138,104,0.11)',
      danger: '#CC3A3A',
      error: '#CC3A3A',
      dangerSoft: 'rgba(204,58,58,0.11)',
      warning: '#B7791F',
      warningSoft: 'rgba(183,121,31,0.12)',
      info: '#3567C8',
      infoSoft: 'rgba(53,103,200,0.11)',
      focusRing: rgba(accent, 0.28),
      overlay: 'rgba(20,33,29,0.45)',
      disabledBg: 'rgba(107,114,128,0.12)',
      disabledText: '#9CA3AF',
      cardShadow: 'rgba(20,33,29,0.08)',
      shimmer: 'rgba(255,255,255,0.9)',
      achievement: gold,
      achievementSoft: rgba(gold, 0.14),
      streak: '#C95F28',
      streakSoft: 'rgba(201,95,40,0.11)',
      growth: '#0F8A68',
      growthSoft: 'rgba(15,138,104,0.11)',
      calm: '#3567C8',
      calmSoft: 'rgba(53,103,200,0.11)',
      gentleWarn: '#B7791F',
      gentleWarnSoft: 'rgba(183,121,31,0.12)',
      urgent: '#CC3A3A',
      urgentSoft: 'rgba(204,58,58,0.11)',
      fresh: '#3567C8',
      freshSoft: 'rgba(53,103,200,0.11)',
      social: '#7B4DB8',
      socialSoft: 'rgba(123,77,184,0.1)',
      confidenceHigh: '#0F8A68',
      confidenceHighSoft: 'rgba(15,138,104,0.11)',
      confidenceMedium: '#B7791F',
      confidenceMediumSoft: 'rgba(183,121,31,0.12)',
      confidenceLow: '#CC3A3A',
      confidenceLowSoft: 'rgba(204,58,58,0.11)',
      roleStudent: accent,
      roleStudentSoft: createAccentSoft(accent, 0.12),
      roleTeacher: '#3567C8',
      roleTeacherSoft: 'rgba(53,103,200,0.11)',
      roleAdmin: gold,
      roleAdminSoft: rgba(gold, 0.14),
      focusSurface: 'rgba(20,33,29,0.06)',
      primary: accent,
      secondary: gold,
      card: '#FFFFFF',
      onAccent: '#FFFFFF',
      chromeTabBar: 'rgba(255,255,255,0.96)',
      chromeTabBorder: 'rgba(20,33,29,0.1)',
      chromeTabItemActive: createAccentSoft(accent, 0.1),
    },
    shadows: {
      sm: { color: '#14211D', opacity: 0.07, radius: 10, offsetY: 3, elevation: 2 },
      md: { color: '#14211D', opacity: 0.1, radius: 18, offsetY: 5, elevation: 5 },
      lg: { color: '#14211D', opacity: 0.12, radius: 24, offsetY: 9, elevation: 9 },
      xl: { color: '#14211D', opacity: 0.15, radius: 32, offsetY: 13, elevation: 13 },
    ...
    animation: sharedAnimation,
    gradients: {
      drawerHeader: ['#EEF4F1', '#FFFFFF'] as const,
      profileHero: ['#EEF4F1', '#FFFFFF', '#FFFFFF'] as const,
