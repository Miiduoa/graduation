...
| 口試 Demo 驗收（Golden Path） | [`docs/ORAL_DEFENSE_DEMO_CHECKLIST.md`](docs/ORAL_DEFENSE_DEMO_CHECKLIST.md)（對齊 **`SmartDashboardScreen`** 「下一個學習動作（Demo）」→ `71378` 教材、`SmartCalendarPanel` 跳課表等）                                                                                                                                                    |
...
| 面向              | 盤點結果                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git tracked files | **`970`** 個（**複核**：`git ls-files \| wc -l`；基準日 **2026-05-15**，含 TronClass demo、`courseChipShell`、`DiscussionThreadDetail`、`SmartDashboard` Golden Path、`ORAL_DEFENSE_DEMO_CHECKLIST` 等）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
