  ...
  it('builds an OIDC authorization url', () => {
    const url = new URL(
      buildWebSsoStartUrl(
        ...
        {
          redirectUri:
            'https://campus-app.web.app/sso-callback?school=DEMO&schoolId=tw-demo-uni&provider=oidc',
          state: 'tx-state',
          nonce: 'tx-nonce',
  ...
  it('builds a CAS login url', () => {
    const url = new URL(
      buildWebSsoStartUrl(
        ...
        {
          redirectUri:
            'https://campus-app.web.app/sso-callback?school=DEMO&schoolId=tw-demo-uni&provider=cas',
        },
      ),
    );
