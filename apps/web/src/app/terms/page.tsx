...
const sections = [
  {
    title: "服務範圍",
    body:
      "校園助手提供公告、課程、成績、校園地圖、訊息與經學校驗證的延伸服務。未完成整合驗收的學校與功能不會出現在正式版。",
  },
  {
    title: "帳號責任",
    body:
      "你必須對自己的登入狀態與裝置安全負責，不得冒用、濫用學校帳號、爬取資料或干擾其他使用者正常使用。",
  },
  {
    title: "支付與交易",
    body:
      "若學校已正式開通支付功能，所有支付行為都以合作支付供應商與校方規範為準；未開通時，正式版不會顯示支付入口。",
  },
  {
    title: "服務調整",
    body:
      "我們可能因法規、學校要求、資訊安全或維運需要調整服務內容。重大變更會透過 App 內公告、Email 或校務通知說明。",
  },
];
