...
- **重算「專案快照」表格中的計數**（與本 README **基準日 2026-05-18（含 LMS v2 第六批 push）** 對目前 repo **已 commit** 狀態一致時，`find … | wc -l` 結果應接近：**1304**／**165**／**15**／**81**／5／24／**66**／4／5／12。歷史節點：**第四批為止≈1138**；**第五批**（含 `supabase/`、lmsV2 前置、staged、[LMS 整合計畫](LMS_%E6%95%B4%E5%90%88%E8%A8%88%E7%95%AB.docx)）**≈1257**。**第六批**（`screens/lmsV2/`、`/lms-admin`、`migrations_combined.sql`、`docs/design` 等）**≈1304**。日後若數字漂移，請以指令輸出為準並更新 README；`git ls-files | wc -l` 務必於 **commit 後**複核）。
...
下列數字為 **2026-05-17 第三～五批**與 **2026-05-18 第六批** GitHub push 後、對 **已 commit** repo 之盤點（見上方 blockquote「第三～六批」；**複核指令**見「README 維護者速查」）。第三批：離線端到端硬化與 QA；**第四批**：Web `AUDIT_V2` 收斂、**🤖** 深連結、`AUDIT_V2_FIXED.md`（**1138→1138+1**）；**第五批**：LMS v2／`supabase/`、migrations、feature flag、[執行手冊](docs/LMS_V2_MIGRATION_RUNBOOK.md)（**約 +119**，**1138→1257**）；**第六批**：Mobile **`lmsV2/*` V2 Screen**、`lmsV2WriteTools`、Web **`/lms-admin`**、`today-v2`、[**`docs/LMS_V2_ROLE_ACTION_MAP.md`](docs/LMS_V2_ROLE_ACTION_MAP.md)**、[**`designTokens`**](packages/shared/src/designTokens.ts)、[**`supabase/migrations_combined.sql`](supabase/migrations_combined.sql)**（**約 +47**，**1257→1304**）。**前一版（0516）**之 **1084／142** 僅見歷史敘述與區塊內對照。

| 面向              | 盤點結果                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git tracked files | **`1304`** 個（**複核**：`git ls-files \| wc -l`。**2026-05-18 第六批**在第五批 **`1257`** 上再累加約 **47** paths，含 Mobile **`screens/lmsV2/`**、Web **`app/lms-admin/`**、`today-v2`、`migrations_combined.sql`、`docs/design`、shared **`designTokens`** 等。**2026-05-17 第五批** LMS v2 前置曾將 tracked **1138**→**1257**。**第四批** **+1**＝根目錄 [`AUDIT_V2_FIXED.md`](AUDIT_V2_FIXED.md)。）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Mobile UI         | **`165`** 個 `apps/mobile/**/*Screen.tsx`、`15` 個 `*Stack.tsx`（複核：`find apps/mobile/src/screens -name '*Screen.tsx' \| wc -l`，Stack 請用 `find … '*Stack.tsx'`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| Web routes        | **`66`** 個 `apps/web/**/page.tsx`、`4` 個 `apps/web/**/route.ts`（第六批後含 **`/lms-admin/*`** 與 **`/today-v2`** 等）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
<h3 id="readme-qa-20260517">本期程式與 QA 對照摘要（2026-05-15–18；含 LMS v2 第六批）</h3>
