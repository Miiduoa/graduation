...
- **重算「專案快照」表格中的計數**（與本 README **基準日 2026-05-15（含角色中控台＋ AI‑Core 本批 merge）** 之表一致時，下列指令應得到：**1055**／**136**／**15**／**74**／5／24／**26**／4／5／12；日後若數字漂移，請以指令輸出為準並更新表格，`git ls-files | wc -l` 請在 **已 commit** 後複核）：
...
| 面向              | 盤點結果                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git tracked files | **`1055`** 個（**複核**：`git ls-files \| wc -l`；基準日 **2026-05-15（本批：`LoginLanding`、`RoleAwareToday`／各 cockpit、`aiContextBuilder`/`aiOrchestrator`/`proactiveAIAgent`、`roleEventBus`、`demoMerchants`／`useMerchantContext`、示範用 docx／xlsx 等）；另含前文列舉 **`studyPlanner`**／**PuWebView**／**`tronClassWebUiGate`**／TronClass demo 資產等）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Mobile UI         | **`136`** 個 `apps/mobile/**/*Screen.tsx`、`15` 個 `*Stack.tsx`（複核：`find apps/mobile/src/screens -name '*Screen.tsx' \| wc -l`，Stack 請用 `find … '*Stack.tsx'`）                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| 測試檔            | Mobile **`74`**（`apps/mobile/src/__tests__/**/*.test.{ts,tsx}`；**不含** `pnpm ai:train:long` 專用之 `apps/mobile/scripts/ai-training-long.test.ts`；代表性 Jest：既有 **LMS／閘道** 類測試外，本批新增 **`aiContextBuilder`**、**`aiDataInventory`**、**`aiOrchestrator`**、**`aiStudyBuddyMatcher`**、**`aiThinkingLearning`**（對應 `aiThinking.ts`/`aiLearning.ts`）、**`resolveDashboardRole`**、**`roleEventBus`** 等）；Web **`5`**、Backend Functions **`24`**、Rules **`1`**（複核指令同前）                                                                                                                                                                                                                                               |
