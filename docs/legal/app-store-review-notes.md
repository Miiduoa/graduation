...
- `NSLocationAlwaysAndWhenInUseUsageDescription` (iOS) - _for optional background location tracking_
...
- `NSPhotoLibraryAddOnlyUsageDescription` (iOS) - _for saving shared photos_
