        ...
        >
          ...
          <View style={{ gap: 8 }}>
            {[
              ...
              {
                facility: '維修中',
                status: `${repairRequests.filter((r) => r.status === 'inProgress').length} 件`,
                color: theme.colors.warning,
              },
              {
                facility: '待處理',
                status: `${repairRequests.filter((r) => r.status === 'pending').length} 件`,
              ...
              >
                ...
                <Text style={{ fontSize: 12, fontWeight: '600', color: item.color }}>
                  {item.status}
                </Text>
              </View>
            ))}
