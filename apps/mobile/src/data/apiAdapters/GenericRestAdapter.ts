...
export class GenericRestAdapter extends BaseApiAdapter {
  ...
  async listAnnouncements(): Promise<Announcement[]> {
    ...
    const raw = this.extractData<RawAnnouncementData>(response.data, this.extractors.announcements);
  ...
  async listEvents(): Promise<ClubEvent[]> {
    ...
    const raw = this.extractData<RawEventData>(response.data, this.extractors.events);
  ...
  async listMenu(): Promise<MenuItem[]> {
    ...
    const raw = this.extractData<RawMenuData>(response.data, this.extractors.menu);
  ...
  async listPois(): Promise<Poi[]> {
    ...
    const raw = this.extractData<RawPoiData>(response.data, this.extractors.pois);
