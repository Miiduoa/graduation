...
- **LMS 演算法契約：** `quizScoring`、`gradebookCompute`、`questionBank`、`rubricScoring`、`discussionEngine`、`riskRadar`、`tronclassAdapter`、**`actionGraph`**（跨角色動作→資料／**訊息／收件流程**／學伴／AI tool 對照；見 `packages/shared/src/lms/`）。
